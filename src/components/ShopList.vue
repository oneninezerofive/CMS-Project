...
export default {
  ...
  methods: {
    ...
    async getData() {
      ...
      let data = await this.$axios("https://elm.cangdu.org/shopping/restaurants?latitude=31.22967&longitude=121.4762");
    ...
    //  商家数量，和总页数
    async adminCount() {
      let data = await this.$axios('https://elm.cangdu.org/shopping/restaurants/count');
